...
#End Region
    ...
    Public Const _ReferenceTX As ULong = 4704998022115171740UL ' testnet = 14302362561079850525UL
    Public Const _ReferenceTXFullHash As String = "9c1d17e1c5824b419671718cccae60784f905ff8e07ef546f7c781b6e2946c13" ' testnet = "1db602def8327cc6650b90d857c079107d4fc542ad7ad60161e83b15929c441a"
    ...
    Private Property C_StartForm As SnipSwapForm
...
#Region "Constructors"
    ...
    Sub New(ByVal StartForm As SnipSwapForm, ByVal Node As String, ByVal ContractID As ULong, Optional ByVal StartDateTime As Date = #01/01/0001#, Optional ByVal RefreshHistoryOrders As Boolean = True)
    ...
    End Sub
    Sub New(ByVal StartForm As SnipSwapForm, ByVal Node As String, ByVal ContractID As ULong, ByVal HistoryOrders As List(Of S_Order), Optional ByVal RefreshHistoryOrders As Boolean = True)
                        ...
                        Select Case Command
                            ...
                            Case E_ReferenceCommand.REFERENCE_CREATE_ORDER
                                ...
                                If ClsSignumAPI.Planck2Dbl(T_TX.AmountNQT) > T_BuyCollateralAmount Then
                                    T_TX.Attachment = "create sell order: " + SnipSwapForm.Dbl2LVStr(ClsSignumAPI.Planck2Dbl(T_TX.AmountNQT) - ClsSignumAPI.Planck2Dbl(ClsDEXContract._GasFeeNQT) - T_BuyCollateralAmount) + " Signa for " + SnipSwapForm.Dbl2LVStr(T_XAmount) + " " + T_XItem
                                Else
                                    T_TX.Attachment = "create buy order: " + SnipSwapForm.Dbl2LVStr(T_BuyCollateralAmount) + " Signa for " + SnipSwapForm.Dbl2LVStr(T_XAmount) + " " + T_XItem
                                End If
                            ...
                            Case E_ReferenceCommand.REFERENCE_CREATE_ORDER_WITH_RESPONDER
                                ...
                                T_TX.Attachment = "create sell order with responder: " + SnipSwapForm.Dbl2LVStr(ClsSignumAPI.Planck2Dbl(T_TX.AmountNQT) - ClsSignumAPI.Planck2Dbl(ClsDEXContract._GasFeeNQT)) + " Signa for " + SnipSwapForm.Dbl2LVStr(T_XAmount) + " " + T_XItem + " to " + T_Responder
                            ...
                            Case E_ReferenceCommand.REFERENCE_MEDIATE_DISPUTE
                                ...
                                T_TX.Attachment = "mediate dispute: " + SnipSwapForm.Dbl2LVStr(ClsSignumAPI.Planck2Dbl(ReferenceMessageList(1)) / 100, 2) + " % to Responder"
