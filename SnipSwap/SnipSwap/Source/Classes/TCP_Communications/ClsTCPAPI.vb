...
Imports SnipSwap.ClsBitcoinTransaction
                            ...
                            Select Case APIRequest.Endpoint
                                    ...
                                    If APIRequest.Parameters.Count > 0 Then
                                        ...
                                        If Not OrderID = "" And PassPhrase = "" And Not PublicKey = "" And Type = "" And AmountNQT = "" And CollateralNQT = "" And XAmountNQT = "" And XItem = "" Then
                                            ...
                                            If MessageIsHEXString(PublicKey) And PublicKey.Length = 64 Then
                                                For Each T_DEXContract As ClsDEXContract In SnipSwapForm.C_DEXContractList
                                                    If T_DEXContract.ID.ToString() = OrderID Then
                                                        ...
                                                        If T_DEXContract.Status = ClsDEXContract.E_Status.OPEN Then 'T_DEXContract.IsSellOrder And
                                                            ...
                                                            Else
                                                                ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""acceptOrder"",""data"":{""unsignedTransactionBytes"":""" + T_UnsignedTransactionBytes + """}}"
                                                            End If
                                                ...
                                                For Each T_DEXContract As ClsDEXContract In SnipSwapForm.C_DEXContractList
                                                    If T_DEXContract.ID.ToString() = OrderID Then
                                                        ...
                                                        If T_DEXContract.Status = ClsDEXContract.E_Status.OPEN Then 'T_DEXContract.IsSellOrder And
                                                            ...
                                                            Else
                                                                '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                                ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""acceptOrder"",""data"":{""transaction"":""" + T_TransactionID + """}}"
                                                            End If
                                            ...
                                            If MessageIsHEXString(PublicKey) And PublicKey.Length = 64 And SupportedCurrencies.Contains(XItem) Then
                                                ...
                                                For Each T_DEXContract As ClsDEXContract In SnipSwapForm.C_DEXContractList
                                                    If T_DEXContract.ID.ToString() = OrderID And (T_DEXContract.Status = ClsDEXContract.E_Status.FREE Or (T_DEXContract.Status = ClsDEXContract.E_Status.NEW_ And T_DEXContract.CreatorID = GetAccountID(PublicKey))) Then
                                                        ...
                                                        Else
                                                            '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                            ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""createOrder"",""data"":{""contract"":""" + T_DEXContract.ID.ToString() + """,""unsignedTransactionBytes"":""" + T_UnsignedTransactionBytes + """}}"
                                                        End If
                                            ...
                                            If MessageIsHEXString(PublicKey) And PublicKey.Length = 64 And SupportedCurrencies.Contains(XItem) Then
                                                ...
                                                For Each T_DEXContract As ClsDEXContract In SnipSwapForm.C_DEXContractList
                                                    If T_DEXContract.ID.ToString() = OrderID And (T_DEXContract.Status = ClsDEXContract.E_Status.FREE Or (T_DEXContract.Status = ClsDEXContract.E_Status.NEW_ And T_DEXContract.CreatorID = GetAccountID(PublicKey))) Then
                                                        ...
                                                        Else
                                                            '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                            ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""createOrder"",""data"":{""transaction"":""" + T_TransactionID + """}}"
                                                        End If
                                        ...
                                        If SupportedCurrencies.Contains(Token) Then
                                            ...
                                            If ClsDEXContract.CurrencyIsCrypto(Token) Then
                                                ...
                                                If Not IsErrorOrWarning(T_Result,,, False) Then
                                                    ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""broadcast"",""data"":{""message"":""" + T_Result + """}}"
                                                End If
                                            End If
                                ...
                                Case ClsAPIRequest.E_Endpoint.SmartContract
                                    ...
                                    If Not ID.Trim() = "" Then
                                        ...
                                        Dim T_Response As String = "{""application"":""SnipSwapDEX"",""Interface"":""API"",""version"":""1"",""contentType"":""application/json"",""response"":""smartContract"",""data"":["
                                        ...
                                        If SnipSwapForm.C_DEXContractList.Count = 0 Then
                        ...
                        Select Case APIRequest.Endpoint
                            ...
                            Case ClsAPIRequest.E_Endpoint.Orders
                                            ...
                                            For Each T_DEXContract As ClsDEXContract In SnipSwapForm.C_DEXContractList
                                                If T_DEXContract.ID.ToString() = OrderID Then
                                                    ...
                                                    If T_DEXContract.Status = ClsDEXContract.E_Status.OPEN Then 'T_DEXContract.IsSellOrder And
                                                        ...
                                                        Else
                                                            ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""acceptOrder"",""data"":{""contract"":""" + T_DEXContract.ID.ToString() + """,""unsignedTransactionBytes"":""" + T_UnsignedTransactionBytes + """}}"
                                                        End If
                                ...
                                Else
                                    ...
                                    If SnipSwapForm.C_DEXContractList.Count > 0 Then
                                        ReservedOrder = SnipSwapForm.C_DEXContractList.FirstOrDefault(Function(reserved) reserved.Status = ClsDEXContract.E_Status.NEW_ And reserved.CreatorID = GetAccountID(PublicKey))
                                        'Nothing
                                    End If
                                            ...
                                            If T_DEXContract.Status = ClsDEXContract.E_Status.FREE Or (T_DEXContract.Status = ClsDEXContract.E_Status.NEW_ And T_DEXContract.CreatorID = GetAccountID(PublicKey)) Then
                                                ...
                                                Else
                                                    ...
                                                    If SignHexKey.Trim() = "" Then
                                                        '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""createOrder"",""data"":{""contract"":""" + T_DEXContract.ID.ToString() + """,""unsignedTransactionBytes"":""" + T_Result + """}}"
                                                    Else
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""createOrder"",""data"":{""transaction"":""" + T_Result + """}}"
                                                    End If
                                        ...
                                        Else
                                            ...
                                            ElseIf T_DEXContract.ID.ToString() = OrderID And T_DEXContract.Status = ClsDEXContract.E_Status.OPEN And InjectChainSwapHash.Trim() = "" And InjectPublicKey.Trim() = "" Then
                                                ...
                                                Else
                                                    ...
                                                    If SignHexKey.Trim() = "" Then
                                                        '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""acceptOrder"",""data"":{""contract"":""" + T_DEXContract.ID.ToString() + """,""unsignedTransactionBytes"":""" + T_Result + """}}"
                                                    Else
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""acceptOrder"",""data"":{""transaction"":""" + T_Result + """}}"
                                                    End If
                                            ...
                                            ElseIf T_DEXContract.ID.ToString() = OrderID And T_DEXContract.Status = ClsDEXContract.E_Status.OPEN And T_DEXContract.IsSellOrder And T_DEXContract.CurrentInitiatorID = GetAccountID(PublicKey) And InjectChainSwapHash.Trim() = "" And MessageIsHEXString(InjectPublicKey) And InjectPublicKey.Length() = 64 Then
                                                ...
                                                Else
                                                    If SignHexKey.Trim() = "" Then
                                                        '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""injectResponder"",""data"":{""contract"":""" + T_DEXContract.ID.ToString() + """,""unsignedTransactionBytes"":""" + T_Result + """}}"
                                                    Else
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""injectResponder"",""data"":{""transaction"":""" + T_Result + """}}"
                                                    End If
                                            ...
                                            ElseIf T_DEXContract.ID.ToString() = OrderID And T_DEXContract.Status = ClsDEXContract.E_Status.OPEN And T_DEXContract.IsSellOrder And T_DEXContract.CurrentInitiatorID = GetAccountID(PublicKey) And InjectPublicKey.Trim() = "" And MessageIsHEXString(InjectChainSwapHash) And InjectChainSwapHash.Length() = 64 Then
                                                ...
                                                Else
                                                    If SignHexKey.Trim() = "" Then
                                                        '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""injectChainSwapHash"",""data"":{""contract"":""" + T_DEXContract.ID.ToString() + """,""unsignedTransactionBytes"":""" + T_Result + """}}"
                                                    Else
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""injectChainSwapHash"",""data"":{""transaction"":""" + T_Result + """}}"
                                                    End If
                                            ...
                                            ElseIf T_DEXContract.ID.ToString() = OrderID And T_DEXContract.Status = ClsDEXContract.E_Status.RESERVED And (T_DEXContract.CurrentInitiatorID = GetAccountID(PublicKey) Or T_DEXContract.CurrentResponderID = GetAccountID(PublicKey)) Then
                                                ...
                                                Else
                                                    If SignHexKey.Trim() = "" Then
                                                        '"{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""" + ResponseText + """,""data"":{""contract"":""" + T_DEXContract.ID.ToString() + """,""unsignedTransactionBytes"":""" + T_Result + """}}"
                                                    Else
                                                        ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""" + ResponseText + """,""data"":{""transaction"":""" + T_Result + """}}"
                                                    End If
                                ...
                                If Not PublicKey.Trim() = "" Then
                                    ...
                                    If Not IsErrorOrWarning(T_Result,,, False) Then
                                        ...
                                        If Not PrivateKey.Trim() = "" Then
                                            ...
                                            If Not IsErrorOrWarning(T_Result,,, False) Then
                                                ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""createSmartContract"",""data"":{""transaction"":""" + T_Result + """}}"
                                            End If
                                        Else
                                            ResponseHTML = "{""application"":""SnipSwapDEX"",""interface"":""API"",""version"":""1.0"",""contentType"":""application/json"",""response"":""createSmartContract"",""data"":{""unsignedTransactionBytes"":""" + UnsignedTransactionBytes + """}}"
                                        End If
    ...
    Private Sub SendHTMLResponse(ByVal TCPClient As TcpClient, ByVal httpRequest As String)
        ...
        Try
            ...
            Dim htmlHeader As String =
                    ...
                    "Server: SnipSwapAPIServer 1.0" & ControlChars.CrLf &
