...
Public Class ClsCSV
    ...
    Public Property ColumnList As List(Of String) = New List(Of String)({"ATID", "SnipSwapAT", "HistoryOrders", "MyCurrentOrderTX", "Type", "Paytype", "Infotext", "AutoSendInfotext", "AutoCompleteAT", "Status"})
