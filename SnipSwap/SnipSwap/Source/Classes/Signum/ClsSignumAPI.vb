...
#End Region
    ...
    'Public Const _AddressPreFix As String = "S-" ' testnet="TS-"
    Public Const _DefaultNode As String = "https://mainnet.signum.zone/api"
    Public Const _Nodes As String = _DefaultNode ' Testnet=+ ";" + "http://tordek.ddns.net:6876/api" + ";" + "http://lmsi.club:6876/api"
...
#Region "Basic API"
    ...
    Function SignumRequest(ByVal postData As String) As String
        ...
        Catch ex As Exception
            'SnipSwapForm.StatusLabel.Text = Application.ProductName + "-error in SignumRequest(" + C_Node + "): " + ex.Message
...
#Region "Get"
    ...
    Public Function IsSmartContract(ByVal AccountID As String, Optional ByVal UseBuffer As Boolean = False) As Boolean
        ...
        If Not UseBuffer Then
            ...
            If Response.Contains(Application.ProductName + "-error") Then
                'SnipSwapForm.StatusLabel.Text = Application.ProductName + "-error in IsSmartContract(): -> " + Response
    ...
    '    If Response.Contains(Application.ProductName + "-error") Then
    '        'SnipSwapForm.StatusLabel.Text = Application.ProductName + "-error in GetAccountFromPassPhrase(): -> " + Response
    '        If GetINISetting(E_Setting.InfoOut, False) Then
...
#End Region
    ...
    Public Function GetSmartContractIds(ByVal ReferenceMachineCodeHashID As ULong) As List(Of String)
        ...
        If Response.Contains(Application.ProductName + "-error") Then
            'SnipSwapForm.StatusLabel.Text = Application.ProductName + "-error in GetSmartContractIds(): -> " + Response
            If GetINISetting(E_Setting.InfoOut, False) Then
...
#Region "Send Advance"
    ...
    Public Function CreateSmartContract(ByVal SenderPublicKey As String, ByVal CreationMachineData As String) As String
        ...
        postDataRL += "&name=CarbonSnipSwapDEXContract"
        postDataRL += "&description=CarbonContract"
