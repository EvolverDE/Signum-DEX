...
Module ModGlobals
    Property GlobalReferenceTransaction As ClsSignumTransaction = New ClsSignumTransaction(ClsDEXContract._ReferenceTX)
    ReadOnly Property GlobalReferenceSignumSmartContract As ClsSignumSmartContract = New ClsSignumSmartContract()
    Property GlobalPublicKey() As String = ""
    Property GlobalAccountID() As ULong = 0UL
    Property GlobalAddress() As String = ""

    Property GlobalInDevelope() As Boolean = False
    Property GlobalPayPalNetwork() As String = "main" 'main=live; sandbox=test 
    Property GlobalBitcoinPrefix() As String = "00" '00=main; 6f=testnet
    Property GlobalSignumPrefix() As String = "S-" 'S-=main; TS-=testnet
    ...
    Function ConvertAddress(ByVal Address As String) As List(Of String)
        ...
        Try
            ...
            If PreFix.Contains(GlobalSignumPrefix) Then
    ...
    Function IsReedSolomon(ByVal RSString As String) As Boolean
        ...
        If RSString.Length > 2 Then
            ...
            If T_PreFix = GlobalSignumPrefix Then
