...
Partial Class FrmGeneralSettings
    ...
    Private Sub InitializeComponent()
        ...
        Me.GrpBxSeller.Text = "PayPal Settings"
        '
        'TabControl2
        '
        ...
        Me.GroupBox2.Text = "Bitcoin Settings"
        '
        'BtBitcoinAddresses
        '
        ...
        Me.TBBitcoinAPIPass.UseSystemPasswordChar = True
        '
        'Label11
        '
        ...
        Me.TBBitcoinAPINode.Text = "http://127.0.0.1:8332"
        '
        'Label8
        '
