...
#Region "Bitcoin"
        ...
        TBBitcoinAPINode.Text = GetINISetting(E_Setting.BitcoinAPINode, If(GlobalInDevelope, "http://127.0.0.1:18332", "http://127.0.0.1:8332"))
        TBBitcoinAPIUser.Text = GetINISetting(E_Setting.BitcoinAPIUser, If(GlobalInDevelope, "bitcointest", "bitcoin"))
        TBBitcoinAPIPass.Text = GetINISetting(E_Setting.BitcoinAPIPassword, If(GlobalInDevelope, "C8_o5A4uu7RHd6Fs8yStABQLSnZ8WWO49tTqp9UD1Bo", "j5Sjnqcxb8KrKGKO7lHyIGHatVfUBJtefatcTWu49jU"))
