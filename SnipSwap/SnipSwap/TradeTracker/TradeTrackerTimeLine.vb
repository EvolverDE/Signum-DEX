...
#End Region
    ...
    Private Sub TradeTrackerTimeLine_MouseDown(sender As Object, e As MouseEventArgs) Handles Me.MouseDown
        ...
        'SnipSwapForm.MultiInvoker(SnipSwapForm.E_MainFormControls.LabDebug, "Visible", True)
        'SnipSwapForm.MultiInvoker(SnipSwapForm.E_MainFormControls.LabDebug, "Text", e.Button.ToString)
