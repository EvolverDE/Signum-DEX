...
Public Class ClsBTCAPI
    ...
    Function BuildRequestString(ByVal APICall As BTC_API_CALLS, ByVal Params As String) As String
        ...
        Select Case APICall
            ...
            Case BTC_API_CALLS.listunspent
                RequestString = "{""jsonrpc"":""1.0"", ""id"":1,""method"":""listunspent"",""params"":[]}"
    ...
    Public Function ListUnspent() As List(Of String)
        LoadWallet()
        Dim Unspends As String = RequestFromBitcoinNode(Full_API_URL, ReqStrToByte(BuildRequestString(BTC_API_CALLS.listunspent, "")))
        Dim JSON As ClsJSON = New ClsJSON
