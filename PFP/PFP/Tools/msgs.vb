...
Public Class msgs
    ...
    Shared t_TimeType As Timer_Art
    ...
    Public Shared Function MBox(Optional ByVal msgTxt As String = "", Optional ByVal titleTxt As String = "", Optional ByVal buttons As List(Of Button) = Nothing, Optional ByVal c_Color As Color = Nothing, Optional ByVal status As msgs.Status = msgs.Status.Standard, Optional ByVal t_time As Integer = -1, Optional ByVal timer_typ As msgs.Timer_Art = msgs.Timer_Art.ButtonEnable)
        ...
        With but
            .Text = "OK"
            .Name = "DefBut"
            .Tag = msgs.CustomDialogResult.OK
        End With
        ...
        Dim ms As msgs = New msgs(titleTxt, msgTxt, buts, c_Color, status, t_time, timer_typ)
        Dim res As msgs.CustomDialogResult = msgs.msbox
    ...
    Sub New(Optional ByVal title As String = "", Optional ByVal msg As String = "", Optional ByVal Buttons As List(Of Button) = Nothing, Optional ByVal colorr As Color = Nothing, Optional ByVal status As Status = Status.Standard, Optional ByVal t_timer As Integer = -1, Optional ByVal timer_type As Timer_Art = Timer_Art.ButtonEnable)
        ...
        For butidx As Integer = 0 To Buttonsl.Count - 1
            ...
            With but
                ...
                If t_Time > -1 Then
                    If timer_type = Timer_Art.ButtonEnable Then
                        .Enabled = False
        ...
        If Not msgText.Contains(vbCrLf) Then
            ...
            If Not status = msgs.Status.Standard Then
        ...
        If status = msgs.Status.Standard Then
    ...
    Shared Sub CountDownTimerTick(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If t_Time < 0 Then
            ...
            If t_TimeType = Timer_Art.AutoOK Then
